...
namespace mge::python {
    ...
    struct python_component_registry_object
    {
        PyObject_HEAD static python_context* context;
    };

    python_context* python_component_registry_object::context = nullptr;
    ...
    PyTypeObject component_type = {
        ...
        // clang-format on
        "__mge__.__component_registry__",         /* tp_name */
        sizeof(python_component_registry_object), /* tp_basicsize */
        0,                                        /* tp_itemsize */
        0,                                        /* tp_dealloc */
        0,                                        /* tp_print */
        0,                                        /* tp_getattr */
                                         ...
                                         python_context*          context)
    {
        ...
        python_component_registry_object::context = context;
    }
} // namespace mge::python
