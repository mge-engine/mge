...
#  error Unsupported Platform
        ...
        vkGetInstanceProcAddr = reinterpret_cast<decltype(vkGetInstanceProcAddr)>(m_library->symbol("vkGetInstanceProcAddr"));
        if (!vkGetInstanceProcAddr) {
            MGE_THROW(mge::illegal_state) << "Entry point \"vkGetInstanceProcAddr\" not found in " << vulkan_library_name;
        }
    }
