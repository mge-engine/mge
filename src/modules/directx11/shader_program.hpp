...
namespace dx11 {
    ...
    {
    public:
        shader_program(mge::render_context &context, mge::shader_type type);
    ...
    public:
        ...
        using shader_t =
            std::variant<vertex_shader_t, pixel_shader_t, compute_shader_t,
                         hull_shader_t, domain_shader_t>;
