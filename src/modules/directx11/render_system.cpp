...
namespace mge {
    ...
    MGE_DEFINE_PARAMETER(bool, directx11, software_device, "Use the DirextX11 software device");
} // namespace mge

namespace mge::dx11 {
    render_system::render_system() { MGE_DEBUG_TRACE(DX11) << "Creating DirectX 11 render system"; }
    ...
    bool render_system::debug() const { return MGE_PARAMETER(directx11, debug).get(); }
    ...
    MGE_REGISTER_IMPLEMENTATION(render_system, mge::render_system, directx11, dx11);
} // namespace mge::dx11
