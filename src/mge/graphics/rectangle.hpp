...
namespace mge {
    ...
    public:
         ...
         * Default constructor.
         */
        inline rectangle() : m_x(0), m_y(0), m_width(0), m_height(0) {}
         ...
         * @return extent
         */
        inline extent extent() const { return mge::extent(m_width, m_height); }
         ...
         */
        inline point position() const { return point(m_x, m_y); }
