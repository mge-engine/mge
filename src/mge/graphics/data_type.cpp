...
namespace mge {
    ...
    data_type_set::data_type_set(const data_type_set& s)
        :m_data(s.m_data)
    {}
    ...
    data_type_set::reference
    data_type_set::operator[](data_type t)
    {
        return m_data[static_cast<uint8_t>(t) - 1];
    }

    bool
    data_type_set::operator[](data_type t) const
    {
        return m_data[static_cast<uint8_t>(t) - 1];
    }

    bool
    data_type_set::test(data_type t) const
    {
