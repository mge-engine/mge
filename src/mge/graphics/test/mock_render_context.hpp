...
namespace mge {
    ...
    public:
        ...
        {
            return render_context::create_index_buffer(usage, buffer);
        }
    };
} // namespace mge
