...
namespace mge {
    shader_program::shader_program(render_context &context, shader_type type)
        : context_object(context), m_type(type), m_defined(false)
    {}

    shader_program::~shader_program() {}

    void shader_program::compile(const std::string &source_code)
    {
    ...
    void shader_program::load(const mge::buffer &buf)
    {
