...
{
    mge::fmat4 m = mge::translate(mge::fmat4(1.0f), mge::fvec3(1.0f, 2.0f, 3.0f));
...
{
    mge::fmat4 m1 = mge::translate(mge::fmat4(1.0f), mge::fvec3(1.0f, 2.0f, 3.0f));
    mge::fmat4 m2 = mge::translate(mge::fmat4(1.0f), mge::fvec3(1.0f, 2.0f, 3.0f));
    while (state.KeepRunning()) {
        auto m3 = m1 * m2;
    }
}
