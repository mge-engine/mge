...
namespace mge {
    ...
    aabox::aabox() : m_min(0.0f, 0.0f, 0.0f), m_max(0.0f, 0.0f, 0.0f) {}
    ...
    aabox::aabox(const aabox &b) : m_min(b.m_min), m_max(b.m_max) {}

    aabox &aabox::operator=(const aabox &b)
    {
        m_min = b.m_min;
        m_max = b.m_max;
        return *this;
    ...
    bool aabox::contains(const fvec3 &v) const
    {
