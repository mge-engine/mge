...
namespace mge {
    ...
    enum class log_severity
    {
        ...
        ERROR = 1, //!< Error log severity, log message describes malfunction in
                   //!< program.
        ERROR_SEVERITY = 1, //!< Error log severity, log message describes
                            //!< malfunction in program.
        WARNING =
            2, //!< Warning severity, log message describes a potential problem.
        WARNING_SEVERITY =
            2, //!< Warning severity, log message describes a potential problem.
