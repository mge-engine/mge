...
namespace mge {
    ...
    const std::string&
    configuration::value(const std::string& key) const
    {
        if(m_prefix.empty()) {
    ...
    void
    configuration::set_override(const std::string& key, const std::string& value)
    {
        configuration_overrides()[key] = value;
    }
    ...
    configuration_key_not_found::configuration_key_not_found(configuration_key_not_found&& e)
