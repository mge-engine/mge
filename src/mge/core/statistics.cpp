...
namespace mge {
    ...
    statistics::description::field_description::field_description(std::string_view                               field_name,
    ...
    statistics::description::field_description::field_description(const statistics::description::field_description& desc)
        : m_name(desc.m_name)
        , m_getter(desc.m_getter)
    {}

    statistics::description::field_description::field_description(statistics::description::field_description&& desc)
        : m_name(desc.m_name)
        , m_getter(std::move(desc.m_getter))
    {}

    statistics::description::field_description&
    statistics::description::field_description::operator=(const statistics::description::field_description& desc)
    {
        m_name = desc.m_name;
        m_getter = desc.m_getter;
        return *this;
    ...
    statistics::description::field_description&
    statistics::description::field_description::operator=(statistics::description::field_description&& desc)
    {
        m_name = desc.m_name;
        m_getter = std::move(desc.m_getter);
        return *this;
