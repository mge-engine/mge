...
namespace mge {
    ...
    public:
        struct measure_point
        {
            ...
            measure_point(uint64_t                 iterations_,
                ...
                : iterations(iterations_), duration(duration_)
            {}
            uint64_t                 iterations;
        ...
        {
        public:
            warmup_stage() : loops(20), iterations(10)
            {
        ...
        public:
            calibrate_stage()
                : loops(10), max_unstable_loops_add(5), iterations(10),
                  current_loop(0), stable(false)
            {}
        ...
        public:
            ...
            void     set_iterations(uint64_t iterations_)
            {
                ...
                distributor = std::uniform_int_distribution<int64_t>(
                    -max_deviate, max_deviate);
            }
    ...
    benchmark::benchmark() : m_print_results(false)
    {
